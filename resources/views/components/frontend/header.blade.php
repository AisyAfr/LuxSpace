        ...
        <div class="w-auto">
          ...
          >
            <li class="mx-3 py-6 md:py-0">
              <a href="#" class="text-black {{\Route::current()->getName() == 'index' ? 'md:text-white' : ''}} hover:underline"
                >Showcase</a
              >
            </li>
            <li class="mx-3 py-6 md:py-0">
            ...
            @auth
            <li class="mx-3 py-6 md:py-0">
              <a href="{{route('dashboard.index')}}" class="text-black {{\Route::current()->getName() == 'index' ? 'md:text-white' : ''}} hover:underline"
                >Dashboard</a
              >
            </li>
            @endauth
            @guest
            <li class="mx-3 py-6 md:py-0">
              <a href="{{route('login')}}" class="text-black {{\Route::current()->getName() == 'index' ? 'md:text-white' : ''}} hover:underline"
                >Login</a
              >
            </li>  
            <li class="mx-3 py-6 md:py-0">
              <a href="{{route('register')}}" class="text-black {{\Route::current()->getName() == 'index' ? 'md:text-white' : ''}} hover:underline"
                >Register</a
              >
            </li>    
            @endguest
            <li class="mx-3 py-6 md:py-0">
              ...
              {{-- <a href="user/profile" class="text-black {{\Route::current()->getName() == 'index' ? 'md:text-black' : ''}} hover:underline"
                >{{Auth::user()->name}}</a --}}
            </li>
          </ul>
        </div>
